      ...
      default:
        return React.createElement(React.Fragment, null,
          ...
          React.createElement('form', { onSubmit: handleSubmit, className: "p-6 space-y-4" },
            ...
            React.createElement('button', { type: "submit", className: "w-full bg-brand-primary hover:bg-blue-600 text-white font-bold py-2.5 px-4 rounded-full transition-colors" }, `${t.payNow} ${planPrice}`)
          )
        );
    }
  };
